...
public class MongoDBTableCreation {
	...
	public static void main(String[] args) {
		...
		// step1: remove old collections.
		db.getCollection("users").drop();
		db.getCollection("items").drop();
		
		// step2: create new collections, insert fake user data and create index.
		...
		// Different to MySQL, users table in MongoDB also has histories info.
